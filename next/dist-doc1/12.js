(window.webpackJsonp=window.webpackJsonp||[]).push([[12],{222:function(n,t,e){"use strict";e.r(t),e.d(t,"Comp",(function(){return r})),e.d(t,"code",(function(){return a}));var i=e(5),s=e(7);async function o(n){return(await Promise.all(n.map(n=>fetch("https://source.unsplash.com/800x500/?"+n)))).map(({url:n})=>i.c`<img src=${(n=>!((new Image).src=n)||n)(n)}>`)}const l={mode:s.TransitionMode.Both,opacity:0,leave:{lock:!0}};class r extends i.a{static get properties(){return{slides:Object,slide:Number}}static get styles(){return i.b`
    :host {
      position: relative;
      display: flex;
      height: 200px;
