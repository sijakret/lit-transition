!function(t){var e={};function n(i){if(e[i])return e[i].exports;var s=e[i]={i:i,l:!1,exports:{}};return t[i].call(s.exports,s,s.exports,n),s.l=!0,s.exports}n.m=t,n.c=e,n.d=function(t,e,i){n.o(t,e)||Object.defineProperty(t,e,{enumerable:!0,get:i})},n.r=function(t){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},n.t=function(t,e){if(1&e&&(t=n(t)),8&e)return t;if(4&e&&"object"==typeof t&&t&&t.__esModule)return t;var i=Object.create(null);if(n.r(i),Object.defineProperty(i,"default",{enumerable:!0,value:t}),2&e&&"string"!=typeof t)for(var s in t)n.d(i,s,function(e){return t[e]}.bind(null,s));return i},n.n=function(t){var e=t&&t.__esModule?function(){return t.default}:function(){return t};return n.d(e,"a",e),e},n.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},n.p="/lit-transition/",n(n.s=7)}([function(t,e,n){"use strict";n.d(e,"c",(function(){return r.a})),n.d(e,"e",(function(){return a.c})),n.d(e,"a",(function(){return i.d})),n.d(e,"b",(function(){return o.b})),n.d(e,"d",(function(){return c})),n.d(e,"f",(function(){return l}));var i=n(2);
/**
 * @license
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const i=new WeakMap,s=t=>(...e)=>{const n=t(...e);return i.set(n,!0),n},o=t=>"function"==typeof t&&i.has(t)},function(t,e,n){"use strict";n.r(e),n.d(e,"TransitionMode",(function(){return d})),n.d(e,"fade",(function(){return h})),n.d(e,"land",(function(){return g})),n.d(e,"slide",(function(){return _})),n.d(e,"mark",(function(){return r})),n.d(e,"transition",(function(){return y}));var i=n(0);function s(t,e,n=!0){return new Promise(i=>{const s=new MutationObserver(async()=>{s.disconnect(),n&&await function t(e=1){return new Promise(n=>0==--e?requestAnimationFrame(()=>n()):n(t(e)))}(),i()});s.observe(t,{attributes:!0,attributeFilter:["class"]}),e&&e()})}const o=new WeakMap;function r(t,e){return o.set(t,e),t}let a;function c(){a=!document.hidden}c(),document.addEventListener("visibilitychange",c,!1);const l=new WeakMap;function u(t){return function(e,n){return async s=>{if(!(s instanceof i.a))throw new Error("The `transition` directive can only be used on nodes");e||(e=i.d`<div></div>`),"string"!=typeof e&&"number"!=typeof e||(e=i.d`<div style="display: inline-block">${e}</div>`);const r=(a=e,o.get(a));var a;let c=l.get(s);const{enter:u,leave:d,onEnter:f,onLeave:h,onAfterEnter:p,onAfterLeave:m,mode:v="in-out"}=n;function g(t){const e=new i.a(s.options);return e.appendIntoPart(s),e.setValue(t),e.commit(),e}function _(t){const{startNode:e,endNode:n}=t;try{e&&t.clear()}catch(n){}e&&e.parentNode&&e.parentNode.removeChild(e),n&&n.parentNode&&n.parentNode.removeChild(n)}async function y(e){f&&await f(),u&&await t.transition(e,u,n),p&&await p()}async function b(e){h&&await h(),d&&await t.transition(e,d,n),_(e),m&&await m()}if(c||l.set(s,c={children:new Map,styles:new Map,transition:n}),t.init&&t.init({transition:n,data:c,add:g,remove:_}),c.last&&r&&r===c.name)c.last.setValue(e),c.last.commit();else if(c.name=r,"in-out"===v){const t=c.last;await y(c.last=g(e)),t&&await b(t)}else if("out-in"===v){const t=c.last;t&&await b(t),await y(c.last=g(e))}else c.last&&b(c.last),await y(c.last=g(e))}}}var d;function f(t){const e=t();for(let n in e)t[n]=e[n];return t}!function(t){t.InOut="in-out",t.OutIn="out-in",t.Both="both"}(d||(d={}));const h=f((function(t={}){const{duration:e=500,ease:n="ease-out",opacity:i=0}=t;return Object.assign({enter:{active:"fade-enter-active",from:"fade-enter-from",to:"fade-enter-to"},leave:{active:"fade-leave-active",from:"fade-leave-from",to:"fade-leave-to",lock:!0},css:`\n    .fade-leave-active {\n      position: fixed;\n      transition: opacity ${e}ms ${n}, transform ${e}ms ${n};\n    }\n    .fade-enter-active {\n      transition: opacity ${e}ms ${n}, transform ${e}ms ${n};\n    }\n  .fade-enter-from, .fade-leave-to {\n    opacity: ${i};\n  }\n  .fade-enter-to, .fade-leave-from {\n    opacity: 1;\n  }\n  `},t)}));class p{constructor(t){this.classes=new Set,this.element=t;const e=(t.getAttribute("class")||"").split(/\s+/);for(const t of e)this.classes.add(t)}add(t){this.classes.add(t),this.commit()}remove(t){this.classes.delete(t),this.commit()}commit(){let t="";this.classes.forEach(e=>t+=e+" "),this.element.setAttribute("class",t)}}let m=!1;const v={async transition(t,e,n){if(!a)return;const{duration:i=n.duration,active:o,from:r,to:c,lock:l}=e,u=function(t){return t.startNode.nextSibling}(t);if(!u)return;let d;l&&(d=function(t){const e=t.getBoundingClientRect();let n=0,i=0;{let e=t.offsetParent;for(;t&&t!==document&&!(t instanceof DocumentFragment)&&t!==e;){const e=window.getComputedStyle(t);n+=t.offsetTop-parseFloat(e.marginTop)||0-t.scrollTop||0,i+=t.offsetLeft-parseFloat(e.marginLeft)||0-t.scrollLeft||0,t=t.parentNode||t.host}}return{left:i,top:n,rect:e}}(u)),await new Promise(async t=>{const e=(n=u,m?new p(n):n.classList||new p(n));var n;const a=t=>Array.isArray(t)?t.forEach(t=>e.add(t)):e.add(t),l=t=>Array.isArray(t)?t.forEach(t=>e.remove(t)):e.remove(t);var f,h;function v(e){if(e){if(e.target!==u)return;e.preventDefault(),e.stopPropagation()}["transitionend","transitioncancel","animationend","animationcancel"].filter(t=>!e||t!==e.type).forEach(t=>u.removeEventListener(t,v)),o&&l(o),r&&l(r),c&&l(c),t()}d&&(h=d,(f=u).style.left=h.left+"px",f.style.top=h.top+"px",f.style.width=h.rect.width+"px",f.style.height=h.rect.height+"px");const g={once:!0};i?setTimeout(v,i):(u.addEventListener("transitionrun",(function(){u.addEventListener("transitionend",v,g),u.addEventListener("transitioncancel",v,g)}),g),u.addEventListener("animationstart",(function(){u.addEventListener("animationend",v,g),u.addEventListener("animationcancel",v,g)}),g)),r&&await s(u,()=>a(r)),o&&await s(u,()=>a(o)),r&&l(r),c&&a(c)})},init({data:t,remove:e,add:n,transition:s}){if(t._cssSource!==s.css&&(t.css&&e(t.css),s.css)){t._cssSource=s.css;let e=s.css;e="string"==typeof e?i.d`<style>${e}</style>`:e,t.css=n(e)}}},g=f((function(t={}){const{duration:e=500,ease:n="linear",opacity:i=0}=t;return Object.assign({enter:{active:"land1-enter-active",from:"land1-enter-from",to:"land1-enter-to"},leave:{active:"land1-leave-active",from:"land1-leave-from",to:"land1-leave-to"},mode:"both",css:`\n      .land1-enter-active {\n        transform-origin: 50% 50%;\n        transition: transform ${e}ms ${n}, opacity ${e}ms ${n};\n      }\n      .land1-leave-active {\n        transform-origin: 50% 50%;\n        position: absolute;\n        transition: transform ${e}ms ${n}, opacity ${e}ms ${n};\n      }\n      .land1-enter-from {\n        opacity: ${i};\n        transform: translate(0px, 0px) scale(3);\n      }\n      .land1-leave-to {\n        transform: translate(0px, 100px);\n        opacity: ${i};\n      }`},t)})),_=f((function(t={}){const{left:e,right:n,up:i,down:s}=t;let o={};e&&(o={x:"-100%",x1:"100%"}),n&&(o={x:"100%",x1:"-100%"}),i&&(o={y:"100%",y1:"-100%"}),s&&(o={y:"-100%",y1:"100%"});let{mode:r,duration:a=500,x:c="100%",y:l="0%",x1:u="",y1:f="",ease:h="ease-out",leavePosition:p="",opacity:m=0}=Object.assign(Object.assign({},o),t);return u=u||c,f=f||l,function t(e,n){for(var i in n)try{n[i].constructor==Object?e[i]=t(e[i],n[i]):e[i]=n[i]}catch(t){e[i]=n[i]}return e}(t,{enter:{active:"slide-enter-active",from:"slide-enter-from"},leave:{active:"slide-leave-active",to:"slide-leave-to"},css:`\n    .slide-enter-active {\n      transition: transform ${a}ms ${h}, opacity ${a}ms ${h};\n    }\n    .slide-leave-active {\n      position: ${p||(r!==d.OutIn?"absolute":"initial")};\n      transition: transform ${a}ms ${h}, opacity ${a}ms ${h};\n    }\n    .slide-leave-to {\n      opacity: ${m};\n      transform: translate(${c}, ${l});\n    }\n    .slide-enter-from {\n      opacity: ${m};\n      transform: translate(${u}, ${f});\n    }`,mode:r})})),y=Object(i.c)((function(t,e=h){return"function"==typeof e&&(e=e()),u(v)(t,function(t={}){const{css:e,duration:n,enter:s={},leave:o={},mode:r=d.Both,onAfterEnter:a,onAfterLeave:c,onEnter:l,onLeave:u}=t;return{duration:n,css:i.d`<style>${e}</style>`,enter:0!=s&&(Array.isArray(s)||"string"==typeof s?{active:s}:Object.assign({active:"enter-active",from:"enter-from",to:"enter-to"},s)),leave:0!=o&&(Array.isArray(o)||"string"==typeof o?{active:o,lock:!1}:Object.assign({active:"leave-active",from:"leave-from",to:"leave-to",lock:!1},o)),onEnter:l,onLeave:u,onAfterEnter:a,onAfterLeave:c,mode:r}}(e))}))},function(t,e,n){"use strict";n.d(e,"b",(function(){return r})),n.d(e,"a",(function(){return a}));var i=n(4),s=n(1);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
